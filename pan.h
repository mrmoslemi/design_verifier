...
#define _nstates4	6	/* :trace: */
#define minseq4	399
#define maxseq4	403
#define nstates_event	_nstates4
#define _endstate4	5

#define in_s_scope(x_y3_)	0

#define src_event	src_ln4
#define reached_event	reached4

#define _nstates3	6	/* :trace: */
#define minseq3	394
#define maxseq3	398
#define _endstate3	5

#define _nstates2	7	/* :trace: */
#define minseq2	388
#define maxseq2	393
#define _endstate2	6

#define _nstates1	67	/* CONTROLLER_environment */
#define minseq1	322
#define maxseq1	387
#define _endstate1	66

#define _nstates0	323	/* controller */
#define minseq0	0
#define maxseq0	321
#define _endstate0	322
...
#define PCONTROLLER_environment	((P1 *)this)
typedef struct P1 { /* CONTROLLER_environment */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 10; /* state    */
#ifdef HAS_PRIORITY
...
typedef struct State {
	...
	#endif
#endif
	uchar Controller_State_cin;
	uchar Coffee_Type_cin;
	uchar Sugar_Counter_cin;
	uchar Milk_Counter_cin;
	uchar Coffee_Counter_cin;
	uchar Another_Timer_cin;
	uchar Producer_State_cin;
	uchar POS_State_cin;
	uchar Action_cin;
	uchar Controller_State_cout;
	uchar Coffee_Type_cout;
	uchar Sugar_Counter_cout;
	uchar Milk_Counter_cout;
	uchar Coffee_Counter_cout;
	uchar Another_Timer_cout;
	uchar Controller_State;
	uchar Coffee_Type;
	uchar Sugar_Counter;
	uchar Milk_Counter;
	uchar Coffee_Counter;
	uchar Another_Timer;
	uchar Producer_State;
	uchar POS_State;
	uchar Action;
...
#define HAS_TRACK	0
/* hidden variable: */	int Another_Timer_value;
