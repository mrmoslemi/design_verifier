mtype = {
	...
	Action_Dec_Milk,
	Action_Inc_Coffee,
	Action_Dec_Sugar}chan Controller_State_cin = [0] of {mtype};
...
active proctype controller (){
	...
	:: Coffee_Type_cin?Coffee_Type_Americano;Coffee_Type=Coffee_Type_Americano;
		...
		:: ((Coffee_Type == Coffee_Type_Americano) &&
		(Controller_State == Controller_State_Info))
		->
	...
	:: Coffee_Type_cin?Coffee_Type_Espresso;Coffee_Type=Coffee_Type_Espresso;
		...
		:: ((Coffee_Type == Coffee_Type_Espresso) &&
		(Controller_State == Controller_State_Info))
		->
		Coffee_Counter_value = 7;
		Milk_Counter_value = 0;
	...
	:: POS_State_cin?POS_State_Failed;POS_State=POS_State_Failed;
		...
		:: ((POS_State == POS_State_Failed) &&
		(Controller_State == Controller_State_POS))
		->
		Controller_State_cout!Controller_State_Select;
	...
	:: Action_cin?Action_Another_Yes;Action=Action_Another_Yes;
		...
		:: ((Action == Action_Another_Yes) &&
		(Controller_State == Controller_State_Another))
		->
		Another_Timer_cout!Another_Timer_Start;
		Controller_State_cout!Controller_State_Info;
	...
	:: Action_cin?Action_Select_Americano;Action=Action_Select_Americano;
		...
		:: ((Action == Action_Select_Americano) &&
		(Controller_State == Controller_State_Select))
		->
		Coffee_Type_cout!Coffee_Type_Americano;
		Controller_State_cout!Controller_State_Info;
	...
	:: Action_cin?Action_Select_Mocha;Action=Action_Select_Mocha;
		...
		:: ((Action == Action_Select_Mocha) &&
		(Controller_State == Controller_State_Select))
		->
		Coffee_Type_cout!Coffee_Type_Mocha;
		Controller_State_cout!Controller_State_Info;
	...
	:: Action_cin?Action_Select_Espresso;Action=Action_Select_Espresso;
		...
		:: ((Action == Action_Select_Espresso) &&
		(Controller_State == Controller_State_Select))
		->
		Coffee_Type_cout!Coffee_Type_Espresso;
		Controller_State_cout!Controller_State_Info;
	...
	:: Action_cin?Action_Select_Latte;Action=Action_Select_Latte;
		...
		:: ((Action == Action_Select_Latte) &&
		(Controller_State == Controller_State_Select))
		->
		Coffee_Type_cout!Coffee_Type_Latte;
		Controller_State_cout!Controller_State_Info;
