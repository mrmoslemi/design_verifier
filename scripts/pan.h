...
#define PanSource	"/home/reza/crouse/design-verifier/resources/properties.pml"
...
#define _nstates2	11	/* p2 */
#define minseq2	48
#define maxseq2	57
#define _endstate2	10

#define _nstates1	43	/* Producer */
#define minseq1	6
#define maxseq1	47
#define _endstate1	42

#define _nstates0	7	/* initializer */
#define minseq0	0
#define maxseq0	5
#define _endstate0	6
...
struct Produce_Timer { /* user defined type */
	uchar state;
	uchar mode;
	int value;
};
struct Producer_State { /* user defined type */
	uchar state;
	uchar mode;
};
struct Door_Lock { /* user defined type */
	uchar state;
	uchar mode;
};
...
#define PProducer	((P1 *)_this)
typedef struct P1 { /* Producer */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 3; /* proctype */
	unsigned _p   : 7; /* state    */
#ifdef HAS_PRIORITY
...
#define Pinitializer	((P0 *)_this)
typedef struct P0 { /* initializer */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 3; /* proctype */
	unsigned _p   : 7; /* state    */
#ifdef HAS_PRIORITY
...
typedef struct State {
	...
	struct Produce_Timer _Produce_Timer;
	struct Producer_State _Producer_State;
	struct Door_Lock _Door_Lock;
#ifdef TRIX
